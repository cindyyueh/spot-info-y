...
// MED TERM (past 6 months)
export const getTopArtistsMed = (time_range = 'medium_term') => {
  return axios.get(`/me/top/artists?time_range=${time_range}`);
};

export const getTopTracksMed = (time_range = 'medium_term') => {
  return axios.get(`/me/top/tracks?time_range=${time_range}`);
};

// LONG TERM (past 12 months)
